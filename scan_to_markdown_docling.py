...
def convert_document_to_markdown(
    ...
    if suffix == ".docx":
        ...
        markdown_content, already_written = _convert_pdf_with_best_path(
            source,
            target_dir,
            unsafe=unsafe,
        ...
        already_written = markdown_content is not None
...
def _convert_pdf_with_best_path(source, target_dir, unsafe=False, force_full_ocr=False, pdf_mode="auto"):
    ...
    return markdown_content, markdown_content is not None
